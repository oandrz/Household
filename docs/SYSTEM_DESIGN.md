...
operator runs `deploy/PROVISION.md` §9. Design:
...
`deploy/PROVISION.md` §9 for turning it on.
...
`deploy/PROVISION.md` §9, run on the box, which generates a password, runs
