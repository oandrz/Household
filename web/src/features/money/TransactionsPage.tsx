  ...
  return (
    <PageContainer>
      <div className="flex items-start justify-between gap-4">
        <div>
          {/* inline-flex, not flex: this Link sits in a plain <div>, not a
              flex container, so it is not blockified -- flex would stretch
              it to the parent's full width, turning the empty space beside
              the text into part of the click target. inline-flex keeps it
              shrink-to-fit while still letting min-h-11 apply and centering
              the text within the taller box (TransactionFilters.tsx's own
